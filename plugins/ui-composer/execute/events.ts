...
/** 本插件自身事件的命名空间。 */
export const COMPOSER_IMPL = 'ui-composer'
...
export function composerStateRecord(connected: boolean): SseRecord {
  return { impl: COMPOSER_IMPL, topic: 'composer.state', payload: { connected } }
}
