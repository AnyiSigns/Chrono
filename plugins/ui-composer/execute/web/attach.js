...
export function isParseable(mime, name) {
...
export function normalizeRef(ref, fallbackMime, fallbackSize) {
...
export function buildAttachment({ name, mime, sha256, size, text }) {
...
export function bytesToBase64(bytes) {
  const list = bytes instanceof Uint8Array ? bytes : Uint8Array.from(bytes ?? [])
  let out = ''
