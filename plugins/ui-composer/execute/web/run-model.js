...
export function isThreadBusy(state, threadKey) {
  return (
...
export function beginWrite(state, threadKey) {
  return { ...state, writing: { ...state.writing, [threadKey]: true } }
}

export function endWrite(state, threadKey) {
...
export function armWrite(state, threadKey, run) {
...
export function releaseWrite(state, threadKey, run) {
...
export function expectTurn(state, threadKey) {
  return { ...state, expecting: { ...state.expecting, [threadKey]: true } }
}

export function clearExpecting(state, threadKey) {
...
export function trackRunStarted(state, run, threadKey) {
 ...
 */
export function trackRunFinished(state, run, threadKey) {
...
function rememberFinished(state, run) {
