 ...
 */
export function parseNotifyState(value: any): any {
...
export function permissionMessageKey(permission: string): string {
...
export function mergeToggles(current: any, patch: any): any {
