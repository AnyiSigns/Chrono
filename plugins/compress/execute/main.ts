...
import { PortLink, RemoteEmbedding, RemoteModel } from './port-link.ts'
...
const HANDLERS = createHandlers({ model: new RemoteModel(LINK), embedding: new RemoteEmbedding(LINK) })
