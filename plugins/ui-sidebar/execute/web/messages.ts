...
export function lookupMessage(table: MessageTable | null | undefined, code: string): MessageEntry {
  const source: MessageTable = typeof table === 'object' && table !== null ? table : FALLBACK_MESSAGES
...
export function formatText(table: MessageTable | null | undefined, code: string, vars?: Record<string, unknown>): string {
