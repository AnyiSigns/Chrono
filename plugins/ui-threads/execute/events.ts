...
/** 本插件自身事件的命名空间。 */
export const THREADS_IMPL = 'ui-threads'
...
export function connectionStateRecord(connected: boolean): SseRecord {
  return { impl: THREADS_IMPL, topic: 'threads.connection', payload: { connected } }
}
